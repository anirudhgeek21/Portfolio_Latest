...
import Drummob from './Drummob.png';
import Nvideamob from './Nvideamob.png';
...
const App = () => {
  ...
  return (
    <div className="bg-black min-h-screen cursor-default flex flex-col items-center justify-center md:mt-0 mt-36">
      <div className="navigation-bar flex justify-between items-center bg-black md:p-6 py-14 md:pt-24 ">
      ...
      <div id="movies" className="w-full flex flex-wrap justify-around md:mb-20 ">
        {moviesData.map((movie) => (
          <div
            key={movie.id}
            className="movie relative border border-gray-800 shadow-2xl rounded-3xl shadow-violet-900 w-full md:w-1/5 lg:w-1/5 xl:w-1/5 mb-20 md:mb-10 lg:mb-10 md:mx-2 lg:mx-4 mx-4 "
            onMouseEnter={() => setHoveredMovie(movie.id)}
            onMouseLeave={() => setHoveredMovie(null)}
          >
            <div className="poster relative overflow-hidden ml rounded-3xl">
