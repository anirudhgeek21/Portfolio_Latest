...
const App = () => {
  ...
  return (
    <div className="bg-black min-h-screen cursor-default flex flex-col items-center justify-center md:mt-0 mt-[-40%]">
