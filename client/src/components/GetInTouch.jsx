...
<form onSubmit = {onSubmitForm}>
      <div className="w-[90%] md:w-5/12 my-auto mx-auto rounded-2xl h-auto md:h-[690px] bg-white p-4 md:p-10">
        ...
        <div className="w-[90%] mt-2 md:mt-0 mx-auto md:mx-0">
          <button type='submit' className="bg-blue-950 hover:bg-purple-700 duration-300 tracking-wide p-2 md:p-5 w-full md:w-[100%] md:ml-[1.67rem] text-white mt-2 md:mt-7 rounded-lg font-inter mx-auto" >
